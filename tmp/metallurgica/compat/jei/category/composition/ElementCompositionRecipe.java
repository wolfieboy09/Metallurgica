...
public class ElementCompositionRecipe extends StandardProcessingRecipe<RecipeWrapper> {
    @Nullable
    public Item item;
    @Nullable
    ...
    public ElementCompositionRecipe(ProcessingRecipeParams params) {
    ...
    public static ElementCompositionRecipe create(List<SubComposition> subCompositions, @Nullable Item item, @Nullable Material material) {
        ...
        if (item != null) {
            return new StandardProcessingRecipe.Builder<>((params) -> new ElementCompositionRecipe(params).set(item,subCompositions), recipeId)
                    .build();
        } else if (material != null) {
            return new StandardProcessingRecipe.Builder<>((params) -> new ElementCompositionRecipe(params).set(material,subCompositions), recipeId)
                    .build();
        }
        return null;
    }
