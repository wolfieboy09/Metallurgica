...
//    item_composition(ElementCompositionRecipe::new),
    ...
    MetallurgicaRecipeTypes(StandardProcessingRecipe.Factory<?> processingFactory) {
    ...
    private static class Registers {
        private static final DeferredRegister<RecipeSerializer<?>> SERIALIZER_REGISTER = DeferredRegister.create(Registries.RECIPE_SERIALIZER, Metallurgica.ID);
        private static final DeferredRegister<RecipeType<?>> TYPE_REGISTER = DeferredRegister.create(Registries.RECIPE_TYPE, Metallurgica.ID);
    }
}
